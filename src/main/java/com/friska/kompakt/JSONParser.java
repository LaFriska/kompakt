...
abstract public class JSONParser {
     ...
     * @throws IllegalTypeException     if the input string contains that cannot be converted to the specified type.
     */
    ...
    /**
     * An object in a JSON string is defined as a string wrapped in curly braces, with 0 or more members (see
     * {@link JSONParser#parseMember(String, NumberType)}) separated by commas. For more information, please refer to
     * <a href="https://www.json.org/json-en.html">the JSON documentations.</a>.
     * This method takes an input JSON substring representing an object and parses it into a {@link JSONObject}.
     *
     * @param value input JSON substring.
     * @param type  type of number to be converted if a number is found inside the object.
     * @return an instance of {@link JSONObject} representing the input string value.
     * @throws IllegalArgumentException if the input string does not represent a JSON object.
     * @throws IllegalTypeException     if the input string contains a number that cannot be converted to the specified type.
     */
    public static JSONObject parseObject(@NotNull String value, @NotNull NumberType type) {
    ...
    /**
     * JSON arrays are defined as a string wrapped in square braces, with 0 or more elements separated by commas inside.
     * This method takes an input JSON substring representing an array and parses it into a Java {@link Object} array.
     * For more information, please refer to <a href="https://www.json.org/json-en.html">the JSON documentations.</a>.
     *
     * @param value input JSON substring
     * @param type  type of number to be converted if a number is found inside the object.
     * @return an {@link Object} array representing the array specified by the input string.
     * @throws IllegalArgumentException if the input string does not represent an array.
     * @throws IllegalTypeException     if the input string contains a number that cannot be converted to the specified type.
     */
    public static Object[] parseArray(@NotNull String value, @NotNull NumberType type) {
        if (!value.startsWith("[") || !value.endsWith("]"))
     ...
     * @throws IllegalTypeException     if the member contains a number that cannot be converted to the specified type.
     */
